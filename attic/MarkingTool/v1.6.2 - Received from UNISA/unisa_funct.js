...
var showAboutInformation = app.trustedFunction(
  function() {
     ...
     app.alert("UNISA eMarking Suite\n" +
               ...
               "\n" +
               "proudly developed by\n" +
               "Pros Software Solutions in conjuction with Paperless and Learning Curve\n" +
               "jabulani.maphalala@pros.co.za | +27 71 624 2820\n" +
               "----------------------------------------------------------------------------\n" +
               "Version 1.6 -  June 2011\n" +
               "\n" +
               "proudly developed by\n" +
			   ...
			   "Bug Squasher\t:: Pest Control\t:: Jabulani Maphalala\n" +
               "----------------------------------------------------------------------------\n", 3);
  }
);